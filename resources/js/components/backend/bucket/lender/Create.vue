        ...
        <div class="bgc-white bd bdrs-3 p-20 mB-20 mT-15">
            <div class="row">
                <h4 class="col-sm-6 c-grey-900 mB-20">
                    <i class="c-deep-orange-500 ti-archive mR-15"></i>New Risk Bucket
                </h4>
                <div class="col-sm-6">
            ...
            <product-form :value="bucket"></product-form>
        </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            fetchBucket() {
                client.get(parentBucketRoute + '/'+ this.bucketid)
                    .then(response => {
